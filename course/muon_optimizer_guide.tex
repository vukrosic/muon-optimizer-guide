...
\author{Vuk Rosić, reviewed by Chaoqi Liang \\ \small \raisebox{-0.2\height}{\includegraphics[width=0.02\textwidth]{/Users/vukrosic/AI Science Projects/muon-course/.agent/skills/md-to-pdf/github.jpg}} \texttt{vukrosic/muon-optimizer-guide}}
...
Find the original Muon code by \href{https://github.com/KellerJordan/Muon/blob/master/muon.py}{searching ``muon keller jordan code''}.

My implementation below contains another improvement - \href{https://arxiv.org/abs/2505.16932}{polar express}. You may just use the original code from the link above or my implementation.
